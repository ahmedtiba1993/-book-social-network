package com.ahmedtiba.book.feedback;

import com.ahmedtiba.book.book.Book;
import com.ahmedtiba.book.book.BookRepository;
...
public class FeedbackService {
    ...
    public PageResponse<FeedbackResponse> findAllFeedbacksByBook(Integer bookId, int page, int size, Authentication connectedUser) {
        ...
        List<FeedbackResponse> feedbackResponses = feedbacks.stream().map(f -> feedbackMapper.toFeedbackResponse(f, connectedUser.getName())).toList();
